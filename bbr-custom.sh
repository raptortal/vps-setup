...
echo ""
echo "=========================================="
echo "BBR и оптимизация TCP/UDP успешно применены!"
echo "=========================================="
echo ""
read -p "Перезагрузить сервер сейчас для полного применения изменений? (y/n): " answer
...
if [[ "$answer" == "y" || "$answer" == "Y" ]]; then
    ...
    echo "ВАЖНО: Не забудь перезагрузить сервер позже командой 'reboot' для полного применения BBR!"
    echo ""
fi
